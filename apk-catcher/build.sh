...
javac --release 8 -encoding UTF-8 -d out/host src/app/jabs/apkcatcher/ApkArchive.java test/app/jabs/apkcatcher/ApkArchiveTest.java
...
assert 'android.permission.INTERNET' not in m
...
PY
# Signing is performed separately. The private key never enters GitHub.
